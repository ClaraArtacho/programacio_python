...
if nota1 == nota2 and nota2 == nota1:
    if nota1 < nota3:
...
elif nota1 == nota3 and nota3 == nota1:
    if nota1 < nota2:
    ...
    print("Valor de la nota 1 es la mes petita = ", nota1)
elif nota2 < nota1 and nota2 < nota3:
    print("Valor de la nota 2 es la mes petita = ", nota2)
else:
    print("Valor de la nota 3 es la mes petita = ", nota3)
